...
class main_window:
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Button("Autómatikus rendelés", key="SELF_ORDER", size=(19, 1)), sg.Button("Név nélküli árucikkek", key="NO_NAMED_PRODUCTS", size=(19, 1))]
        ]
        self.window = sg.Window(title="Raktár kezelő", layout=layout)
        self.nc = None
